...
class InterfaceRTCBeforeActionsAuto extends DolibarrTriggers
{
	...
	public function runTrigger($action, $object, User $user, Translate $langs, Conf $conf)
	{
		...
		if ($action == 'RELATIONTIERS_CREATE') {
            ...
            if (empty($object->actionmsg2)) $object->actionmsg2 = $langs->transnoentities("RTCRelationTiersNewRelationTiersToDolibarr", $object->thirdparty->getFullName($langs), $object->contact->getFullName($langs));
        ...
        elseif ($action == 'RELATIONTIERS_MODIFY') {
            ...
            if (empty($object->actionmsg2)) $object->actionmsg2 = $langs->transnoentities("RTCRelationTiersModifiedInDolibarr", $object->thirdparty->getFullName($langs), $object->contact->getFullName($langs));
        ...
        elseif ($action == 'RELATIONTIERS_DELETE') {
            ...
            if (empty($object->actionmsg2)) $object->actionmsg2 = $langs->transnoentities("RTCRelationTiersDeletedInDolibarr", $object->thirdparty->getFullName($langs), $object->contact->getFullName($langs));
        ...
        elseif ($action == 'RELATIONCONTACT_CREATE') {
            ...
            if (empty($object->actionmsg2)) $object->actionmsg2 = $langs->transnoentities("RTCRelationContactNewRelationContactToDolibarr", $contact_a->getFullName($langs), $contact_b->getFullName($langs));
        ...
        elseif ($action == 'RELATIONCONTACT_MODIFY') {
            ...
            if (empty($object->actionmsg2)) $object->actionmsg2 = $langs->transnoentities("RTCRelationContactModifiedInDolibarr", $contact_a->getFullName($langs), $contact_b->getFullName($langs));
        ...
        elseif ($action == 'RELATIONCONTACT_DELETE') {
            ...
            if (empty($object->actionmsg2)) $object->actionmsg2 = $langs->transnoentities("RTCRelationContactDeletedInDolibarr", $contact_a->getFullName($langs), $contact_b->getFullName($langs));
