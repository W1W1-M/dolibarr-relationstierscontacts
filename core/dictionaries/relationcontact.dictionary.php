...
/**
 * \file        htdocs/relationstierscontacts/core/dictionaries/relationcontact.dictionary.php
 * \ingroup     relationstierscontacts
 * \brief       Class of the dictionary relation contact
 */
 ...
 */
class RelationContactDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'RTCRelationContactDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_relationcontact';
    ...
    public $fields = array(
        ...
        'label_a_b' => array(
            'name'       => 'label_a_b',
            'label'      => 'RTCRelationContactLabelAB',
            'type'       => 'varchar',
            'database'   => array(
              'length'   => 255
            ),
        ...
        'label_b_a' => array(
            'name'       => 'label_b_a',
            'label'      => 'RTCRelationContactLabelBA',
            'type'       => 'varchar',
            'database'   => array(
                'length'   => 255
            ),
